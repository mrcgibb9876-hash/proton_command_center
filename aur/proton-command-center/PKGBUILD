...
pkgver=1.25.0
pkgrel=1
pkgdesc="Per-game launch options, Proton selection, DLSS/FSR DLL management, native Ultra+ mod install, MangoHud benchmarks, and controller navigation for Steam on Linux"
arch=('any')
